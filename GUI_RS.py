...
def take_img():
    try:
        ...
        Enrollment = txt.get()
        Name = txt2.get()
        path = 'C:/Users/Jeet/Desktop/Attendance_management_system/Datasets/' + Enrollment + ' ' + Name
        new_path = 'C:/Users/Jeet/Desktop/Attendance_management_system/Datasets/' + Enrollment + ' ' + Name + '/'
        os.mkdir(path)
        sampleNum = 0

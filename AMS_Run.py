...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/Jeet/Desktop/Attendance_management_system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            DATA_SUB = tk.Button(MFW, text="Enter Data",command=enter_data_DB, fg="black", bg="lime green",width=20, height=2, activebackground="Red", font=('times', 15, 'bold'))
            DATA_SUB.place(x=170, y=300)
            MAKE_CSV = tk.Button(MFW, text="convert to CSV",command=create_csv, fg="black", bg="red", width=20, height=2, activebackground="Red", font=('times', 15, 'bold'))
            MAKE_CSV.place(x=570, y=300)
            
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"c:\users\Jeet\Desktop\Attendance_management_system\Attendance\Manually Attendance\-------Check attendance------"')
    ...
    SUB = tk.Label(sb, text="Enter Subject", width=15, height=2, fg="white", bg="yellow", font=('times', 15, ' bold '))
    SUB.place(x=30, y=100)

    global SUB_ENTRY

    SUB_ENTRY = tk.Entry(sb, width=20, bg="blue", fg="red", font=('times', 23, ' bold '))
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/Jeet/Desktop/Attendance_management_system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\Jeet\Desktop\Attendance_management_system\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'jeet' :
            if password == 'jeetl14320':
                ...
                cs = 'C:/Users/Jeet/Desktop/Attendance_management_system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
